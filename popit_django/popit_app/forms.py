...
class inscription_form(forms.Form):
    nom = forms.CharField(label_suffix = " : ", label = 'Prénom', max_length=255, widget=forms.TextInput({'class':'form-control'}))
    prenom = forms.CharField(label_suffix = " : ", label = 'Nom', max_length=255, widget=forms.TextInput({'class':'form-control'}))
    email = forms.EmailField(label_suffix = " : ", label = 'Adresse mail', widget=forms.EmailInput({'placeholder': 'Entrez votre adresse mails', 'class':'form-control'}))
